...
#define NLIB_OFFSET_CHUNK 14
#define NLIB_OFFSET_PAYLOAD 15
#define NLIB_OFFSET_PAYLOAD_CHUNK 21

#define NLIB_HEADER_SIZE_NETWORK 5
#define NLIB_HEADER_SIZE_RELIABLE 9
#define NLIB_HEADER_SIZE_CHUNK_NONE 1
#define NLIB_HEADER_SIZE_CHUNK_SOME 7

#define NLIB_CHUNK_RETRY_LIMIT_NONE 0
#define NLIB_CHUNK_RETRY_LIMIT_SOME 5
